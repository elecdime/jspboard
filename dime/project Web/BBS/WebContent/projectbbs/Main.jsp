  ...
  <body>
        ...
        <div class="jumbotron">
            <div class="container">
             ...
             <p>   <a role="button" class="btn btn-primary btn-pull" href="#" onclick="window.open('../projectbbs/profile.jsp','tistory','width=400, height=400, scrollbars=no, resizable=no, toolbars=no, menubar=no')">자세히 보기
</a></p>
